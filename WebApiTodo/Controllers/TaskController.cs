...
namespace WebApiTodo.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        // GET: api/Task
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TaskModel>>> GetTareas()
        {
        ...
        {
            var taskModel = await _context.Tareas.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteTaskModel(int id)
        {
            ...
            _context.Tareas.Remove(taskModel);
            await _context.SaveChangesAsync();
